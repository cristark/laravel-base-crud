    ...
    <form method="post" action="{{route('cars.store')}}">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputMarca" placeholder="Inserisci la Marca" name="marca">
            </div>

            <div class="form-group col-md-6">
                <label for="inputModello">Modello</label>
                <input type="text" class="form-control" id="inputModello" placeholder="Inserisci il Modello" name="modello">
            </div>
        </div>

        <div class="form-group">
            <label for="inputColore">Colore</label>
            <input type="text" class="form-control" id="inputColore" placeholder="Inserisci il Colore" name="colore">
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" class="form-control" id="inputCavalli" name="cavalli">
            </div>

            <div class="form-group col-md-2">
                <label for="inputCilindri">Cilindri</label>
                <input type="number" class="form-control" id="inputCilindri" name="cilindri">
            </div>

            <div class="form-group col-md-4">
                <label for="inputGuida">Guida</label>
                <input type="text" class="form-control" id="inputGuida" name="guida">
            </div>
        </div>
